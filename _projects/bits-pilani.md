...
- [Accelerating Image Processing on FPGA and GPGPU]({% link _projects/bits-ceeri-image-processing.md %})
- [Two-Stage Unbuffered Op-Amp Design Using gm/ID]({% link _projects/bits-gmid-op-amp.md %})
